...
def b5_cubefit(vmin=9.4, vmax=11.1, do_plot=False, multicore=1, file_out='test.fits', Tk_mean=10., fix_Tk=False):
    """
    ...
    cubes.fiteach(fittype='cold_ammonia',  guesses=guesses,
                  ...
                  fixed = [ fix_Tk, F, F, F, F, T], signal_cut = 2,
...
b5_cubefit(multicore=20, file_out=thickFile_NH3, Tk_mean=9.5, fix_Tk=False)
